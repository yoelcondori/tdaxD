...
<div class="login-box">
  ...
  <div class="login-box-body" style="background-color: #B7B4BA">
    ...
    <form action="<?php echo base_url() ?>frontend/auth/login" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Email" name="nombre" required>
 ...
 <!--      <?php if ($this->session->flashdata("error")): ?>
      ...
      <div>
        <a href="<?php echo base_url();?>frontend/auth/registro"><button type="submit" class="btn btn-success btn-block btn-flat">Registrarse</button></a>
      </div>
  </div>
  <!-- /.login-box-body -->
</div>
