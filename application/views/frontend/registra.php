...
<div class="login-box">
  ...
  <div class="login-box-body" style="background-color: #B7B4BA">
    ...
    <form name="form_reg" action="<?php echo base_url() ?>frontend/auth/registro" method="POST">
      ...
      <div>
        <button type="submit" value="Entrar" name="registra" class="btn btn-success btn-block btn-flat">Registrarse</button>
      </div>
