...
<section class="content" style="background-image:url('https://www.iwantwallpaper.co.uk/images/muriva-books-faux-effect-wallpaper-j43027-p968-1441_image.jpg');">
      <!-- Default box -->
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title" style="text-shadow: 1px 0px 3px #042528
          ;color: #154A4F">Tablero Principal</h3>
