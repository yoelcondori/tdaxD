<section class="content" style="background:url(https://cdn.20m.es/img2/recortes/2018/02/01/629129-600-338.jpg?v=20180223181031)">
      <!-- Default box -->
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title" style="text-shadow: 1px 0px 3px #042528
          ;color: #154A4F">Lista de Facultades</h3>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12 text-right">
                    <a href="<?php echo base_url(); ?>backend/facultades/add" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i style="text-shadow: 1px 0px 3px #042528
          ;color: #154A4F"> Nueva Facultad</a>
                </div>
            </div>
            <!-- /.row -->
             <hr>
